...
export class PaginatedDataSource<TModel, TQuery> implements DataSource<TModel>, IPaginatedDataSource
{
    ...
    readonly page$: Observable<PagedResult<TModel>>;
     ...
     * */
    // @ts-ignore
    connect( collectionViewer: CollectionViewer ): Observable<readonly TModel[]> {
